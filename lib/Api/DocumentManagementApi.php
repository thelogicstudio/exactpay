...
/**
    ...
    /**
     * Operation getRetrieveDocumentRequestActual
     *
     ...
     * @param  string $onboarding_id The Onboarding Application identifier. (required)
     * @param  string $document_request_id The Document Request identifier. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRetrieveDocumentRequestActual'] to see the possible values for this operation
     *
     * @throws \TheLogicStudio\ExactPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \TheLogicStudio\ExactPay\Model\OnboardingDocumentRequestResponse|string|string|string|string
     */
    public function getRetrieveDocumentRequestActual($organization_id, $onboarding_id, $document_request_id, string $contentType = self::contentTypes['getRetrieveDocumentRequestActual'][0])
    {
        list($response) = $this->getRetrieveDocumentRequestActualWithHttpInfo($organization_id, $onboarding_id, $document_request_id, $contentType);
        return $response;
    }

    /**
     * Operation getRetrieveDocumentRequestActualWithHttpInfo
     *
     * Retrieve Document Request
     *
     * @param  string $organization_id The Organization identifier. (required)
     ...
     * @return array of \TheLogicStudio\ExactPay\Model\OnboardingDocumentRequestResponse|string|string|string|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRetrieveDocumentRequestActualWithHttpInfo($organization_id, $onboarding_id, $document_request_id, string $contentType = self::contentTypes['getRetrieveDocumentRequestActual'][0])
    {
        $request = $this->getRetrieveDocumentRequestActualRequest($organization_id, $onboarding_id, $document_request_id, $contentType);
    ...
    /**
     * Operation getRetrieveDocumentRequestActualAsync
     *
     * Retrieve Document Request
     *
     * @param  string $organization_id The Organization identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRetrieveDocumentRequestActualAsync($organization_id, $onboarding_id, $document_request_id, string $contentType = self::contentTypes['getRetrieveDocumentRequestActual'][0])
    {
        return $this->getRetrieveDocumentRequestActualAsyncWithHttpInfo($organization_id, $onboarding_id, $document_request_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRetrieveDocumentRequestActualAsyncWithHttpInfo
     *
     * Retrieve Document Request
     *
     * @param  string $organization_id The Organization identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRetrieveDocumentRequestActualAsyncWithHttpInfo($organization_id, $onboarding_id, $document_request_id, string $contentType = self::contentTypes['getRetrieveDocumentRequestActual'][0])
    {
        $returnType = '\TheLogicStudio\ExactPay\Model\OnboardingDocumentRequestResponse';
        $request = $this->getRetrieveDocumentRequestActualRequest($organization_id, $onboarding_id, $document_request_id, $contentType);
    ...
    /**
     * Create request for operation 'getRetrieveDocumentRequestActual'
     *
     * @param  string $organization_id The Organization identifier. (required)
     * @param  string $onboarding_id The Onboarding Application identifier. (required)
     * @param  string $document_request_id The Document Request identifier. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRetrieveDocumentRequestActualRequest($organization_id, $onboarding_id, $document_request_id, string $contentType = self::contentTypes['getRetrieveDocumentRequestActual'][0])
    {

        // verify the required parameter 'organization_id' is set
        if ($organization_id === null || (is_array($organization_id) && count($organization_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organization_id when calling getRetrieveDocumentRequestActual'
            );
        }
        ...
        if ($onboarding_id === null || (is_array($onboarding_id) && count($onboarding_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $onboarding_id when calling getRetrieveDocumentRequestActual'
            );
        }
        ...
        if ($document_request_id === null || (is_array($document_request_id) && count($document_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $document_request_id when calling getRetrieveDocumentRequestActual'
            );
        }
