...
class NotFoundError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Error code that shows what kind of error occur during the execution of the endpoint.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Contains a detailed message on the actual error.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Specifies the type of error that ocurred in the API, this will give you more insight on what failed during the execution of the endpoint.
     *
     * @return self
     */
     ...
     * Sets request_id
     *
     * @param string|null $request_id UUID that represents the id in Exact Payments system, you can use this when contacting support team to provide more information of an specific failure.
     *
     * @return self
     */
