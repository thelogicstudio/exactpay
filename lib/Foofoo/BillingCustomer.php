 ...
 */
class BillingCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingCustomer';
    ...
    protected static $openAPITypes = [
        ...
        'phone' => 'string',
        'phone_type' => 'string',
        'address' => '\TheLogicStudio\ExactPay\Foofoo\BillingAddress'
    ];
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling BillingCustomer., must be smaller than or equal to 20.');
        }
     ...
     * Sets phone_type
     *
     * @param string|null $phone_type H = Home, W = Work, D = Day, N = Night. Phone type is required when a phone number is supplied.
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \TheLogicStudio\ExactPay\Foofoo\BillingAddress|null
     */
     ...
     * Sets address
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\BillingAddress|null $address address
     *
     * @return self
     */
