...
/**
 * UnderwritingWorkflowRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class UnderwritingWorkflowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnderwritingWorkflowRequest';
    ...
    */
     ...
     * Gets rules
     *
     * @return \TheLogicStudio\ExactPay\Foofoo\UnderwritingRuleRequestInner[]|null
     */
     ...
     * Sets rules
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\UnderwritingRuleRequestInner[]|null $rules The list of Rules available for the Underwriting Workflow process that can be used to evaluate the Onboarding Application.
     *
     * @return self
     */
    public function setRules($rules)
    {
        ...
        if ((count($rules) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rules when calling UnderwritingWorkflowRequest., number of items must be greater than or equal to 1.');
        }
