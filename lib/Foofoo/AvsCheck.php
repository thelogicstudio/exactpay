 ...
 */
class AvsCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvsCheck';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code AVS response code received from the processor.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the AVS code.
     *
     * @return self
     */
