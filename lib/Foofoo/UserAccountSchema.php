...
/**
 * UserAccountSchema Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class UserAccountSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserAccountSchema';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'roles' => 'string[]',
        'permission' => '\TheLogicStudio\ExactPay\Foofoo\Permissions[]',
        'email' => 'string',
        'phone' => 'string'
    ];
    ...
    */
     ...
     * Sets permission
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\Permissions[]|null $permission permission
     *
     * @return self
     */
