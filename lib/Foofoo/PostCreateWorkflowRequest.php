...
/**
 * PostCreateWorkflowRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class PostCreateWorkflowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_create_workflow_request';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'entry_rule' => 'string',
        'rules' => '\TheLogicStudio\ExactPay\Foofoo\UnderwritingRuleRequestInner[]',
        'metadata' => 'object'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['entry_rule'] === null) {
            $invalidProperties[] = "'entry_rule' can't be null";
        }
     ...
     * Sets entry_rule
     *
     * @param string $entry_rule The name of the entry Rule in the ruleset of this Underwriting Workflow to start evaluating the Onboarding Application.
     *
     * @return self
     */
     ...
     * Gets rules
     *
     * @return \TheLogicStudio\ExactPay\Foofoo\UnderwritingRuleRequestInner[]
     */
     ...
     * Sets rules
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\UnderwritingRuleRequestInner[] $rules The list of Rules available for the Underwriting Workflow process that can be used to evaluate the Onboarding Application.
     *
     * @return self
     */
    public function setRules($rules)
    {
        ...
        if ((count($rules) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rules when calling PostCreateWorkflowRequest., number of items must be greater than or equal to 1.');
        }
