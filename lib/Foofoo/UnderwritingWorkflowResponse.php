...
class UnderwritingWorkflowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'default' => 'bool',
        'entry_rule' => 'string',
        'rules' => '\TheLogicStudio\ExactPay\Foofoo\UnderwritingRuleResponseInner[]',
        'metadata' => 'object',
        'organization' => 'string',
        'created_at' => 'string',
        'updated_at' => 'string'
    ...
    */
     ...
     * Sets _id
     *
     * @param string|null $_id Underwriting Workflow Identifier.
     *
     * @return self
     */
     ...
     * Gets rules
     *
     * @return \TheLogicStudio\ExactPay\Foofoo\UnderwritingRuleResponseInner[]|null
     */
     ...
     * Sets rules
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\UnderwritingRuleResponseInner[]|null $rules The list of Rules available for the Underwriting Workflow process that can be used to evaluate the Onboarding Application.
     *
     * @return self
     */
