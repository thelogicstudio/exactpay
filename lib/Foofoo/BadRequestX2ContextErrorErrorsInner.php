...
/**
 * BadRequestX2ContextErrorErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class BadRequestX2ContextErrorErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BadRequestX2ContextError_errors_inner';
    ...
    */
     ...
     * Sets kind
     *
     * @param string|null $kind The kind of error reported.
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string|null $path The field path in the submitted object caused this error.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The value of the field caused this error. This is applicable only when kind is not `required`.
     *
     * @return self
     */
