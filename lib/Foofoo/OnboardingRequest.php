 ...
 */
class OnboardingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'client_ip' => 'string',
        'type' => 'string',
        'merchant' => '\TheLogicStudio\ExactPay\Foofoo\OnboardingMerchant'
    ];
    ...
    */
     ...
     * Sets workflow
     *
     * @param string|null $workflow The Workflow Identifier that will be used to onboard the Application. If the Workflow identifier is not sent (or) the Workflow identifier sent is wrong, then the default Workflow of the Organization that is submitting the Onboarding Application will be used.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of entity being boarded. To onboard a Partner use `organization` and to onboard a Merchant use `account`.
     *
     * @return self
     */
     ...
     * Gets merchant
     *
     * @return \TheLogicStudio\ExactPay\Foofoo\OnboardingMerchant
     */
     ...
     * Sets merchant
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\OnboardingMerchant $merchant merchant
     *
     * @return self
     */
