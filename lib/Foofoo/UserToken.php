...
class UserToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'mode' => '\TheLogicStudio\ExactPay\Foofoo\AccountMode',
        'token' => 'string',
        'type' => 'string',
        'user' => 'mixed',
        'application' => 'string',
    ...
    */
     ...
     * Gets mode
     *
     * @return \TheLogicStudio\ExactPay\Foofoo\AccountMode|null
     */
     ...
     * Sets mode
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\AccountMode|null $mode mode
     *
     * @return self
     */
     ...
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\Permissions[]|null $allowed_permissions Operations that can be performed with the created User Token.
     *
     * @return self
     */
