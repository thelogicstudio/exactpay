...
/**
 * CreateCardPaymentMethodBillingDetails Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class CreateCardPaymentMethodBillingDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCardPaymentMethod_billingDetails';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling CreateCardPaymentMethodBillingDetails., must be smaller than or equal to 20.');
        }
