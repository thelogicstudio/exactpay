...
class BusinessProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'acceptance_methods' => '\TheLogicStudio\ExactPay\Foofoo\AcceptanceMethods',
    ...
    */
    ...
    public function setServicesDescription($services_description)
    {
        ...
        if ((!preg_match("/[A-Za-z]+/", $services_description))) {
    ...
    public function setCurrentProcessor($current_processor)
    {
        ...
        if ((!preg_match("/[A-Za-z]+/", $current_processor))) {
    ...
    public function setCurrentGateway($current_gateway)
    {
        ...
        if ((!preg_match("/[A-Za-z]+/", $current_gateway))) {
    ...
    public function setReasonForLeaving($reason_for_leaving)
    {
        ...
        if ((!preg_match("/[A-Za-z]+/", $reason_for_leaving))) {
     ...
     *
     * @return \TheLogicStudio\ExactPay\Foofoo\AcceptanceMethods
     */
     ...
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\AcceptanceMethods $acceptance_methods acceptance_methods
     *
     * @return self
     */
    ...
    public function setRecurringServicesDescription($recurring_services_description)
    {
        ...
        if ((!preg_match("/[A-Za-z]+/", $recurring_services_description))) {
    ...
    public function setRefundPolicyDescription($refund_policy_description)
    {
        ...
        if ((!preg_match("/[A-Za-z]+/", $refund_policy_description))) {
