...
/**
 * LinkPaymentMethodPathIssues Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class LinkPaymentMethodPathIssues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'link_payment_method_path_issues';
    ...
    public const DETAILS_EXPECTED_STRING_RECEIVED_NUMBER = 'Expected string, received number';
    public const DETAILS_EXPECTED_BOOLEAN_RECEIVED_STRING = 'Expected boolean, received string';
    ...
    {
        return [
            self::DETAILS_EXPECTED_STRING_RECEIVED_NUMBER,
            self::DETAILS_EXPECTED_BOOLEAN_RECEIVED_STRING,
