...
class ApplicationTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Determines the type of the token. This endpoint only retrieves Application Tokens. For more details, check our [guide](https://developer.exactpay.com/docs/Authentication).
     *
     * @return self
     */
     ...
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\Permissions[]|null $allowed_permissions Operations that can be performed with the Application Tokens.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The date and time when the Application Token was created.
     *
     * @return self
     */
