...
/**
 * MerchantWithoutPrincipal Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class MerchantWithoutPrincipal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MerchantWithoutPrincipal';
    ...
    protected static $openAPITypes = [
        ...
        'terms_n_conditions' => '\TheLogicStudio\ExactPay\Foofoo\MerchantWithoutPrincipalTermsNConditions'
    ];
    ...
    */
     ...
     * Sets principal
     *
     * @param object[]|null $principal The details for the Principal owner(s) of the Business. This field will always be an empty array since this endpoint doesn't support listing of all Principals.
     *
     * @return self
     */
     ...
     * Sets mcc
     *
     * @param string|null $mcc The [Merchant Category Codes](/operations/listMerchantCategoryCodes) of the Organization or Account. Prohibited or high-risk MCC codes are identified by Exact and are marked accordingly. Prohibited accounts are immediately declined while onboarding.
     *
     * @return self
     */
     ...
     *
     * @return \TheLogicStudio\ExactPay\Foofoo\MerchantWithoutPrincipalTermsNConditions|null
     */
     ...
     *
     * @param \TheLogicStudio\ExactPay\Foofoo\MerchantWithoutPrincipalTermsNConditions|null $terms_n_conditions terms_n_conditions
     *
     * @return self
     */
