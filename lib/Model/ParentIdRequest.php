...
/**
 * ParentIdRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class ParentIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParentIdRequest';
    ...
    */
     ...
     * Sets parent_account
     *
     * @param string|null $parent_account Unique identifier of the parent organization for the created PayFac
     *
     * @return self
     */
