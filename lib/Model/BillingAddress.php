    ...
    */
    ...
    public function setLine1($line1)
    {
        ...
        if ((mb_strlen($line1) > 30)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling BillingAddress., must be smaller than or equal to 30.');
        }
    ...
    public function setLine2($line2)
    {
        ...
        if ((mb_strlen($line2) > 28)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling BillingAddress., must be smaller than or equal to 28.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling BillingAddress., must be smaller than or equal to 2.');
        }
     ...
     * Sets postal_code
     *
     * @param string $postal_code The postal code where the customer is located. Five-digit (example: 33558) or nine-digit (33558-3321) format is acceptable for the USA. Six digit(A0A 0A0) or (A0A0A0) format is acceptable for Canada.
     *
     * @return self
     */
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling BillingAddress., must be smaller than or equal to 10.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", $country_code))) {
            throw new \InvalidArgumentException("invalid value for \$country_code when calling BillingAddress., must conform to the pattern /^[A-Z]{3}$/.");
        }
