...
/**
 * UpdatableOnboardingDocument Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class UpdatableOnboardingDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatableOnboardingDocument';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Type of the document to be updated
     *
     * @return self
     */
