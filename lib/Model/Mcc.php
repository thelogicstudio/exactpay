 ...
 */
class Mcc implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Mcc';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Merchant category code (MCCs) is a four-digit number that a credit card issuer uses to categorize the transactions consumers complete using a particular card.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the Merchant category code.
     *
     * @return self
     */
