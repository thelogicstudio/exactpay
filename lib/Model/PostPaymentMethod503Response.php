...
/**
 * PostPaymentMethod503Response Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class PostPaymentMethod503Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_payment_method_503_response';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Code of the custom error.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Message explaining the custom error.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type It is shows as custom error.
     *
     * @return self
     */
