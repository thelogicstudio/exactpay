...
class BankingDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setBankName($bank_name)
    {
        ...
        if ((!preg_match("/^(?=.*[a-zA-Z])[a-zA-Z\\s'-.&,\/()]+/", ObjectSerializer::toString($bank_name)))) {
    ...
    public function setDdaNumber($dda_number)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", ObjectSerializer::toString($dda_number)))) {
    ...
    public function setBankNumber($bank_number)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", ObjectSerializer::toString($bank_number)))) {
