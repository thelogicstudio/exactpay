...
/**
 * UpdatableMerchantAddress Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class UpdatableMerchantAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatableMerchantAddress';
    ...
    */
     ...
     * Sets postal_code
     *
     * @param string $postal_code The postal code where the business is located. Five-digit (example: 33558) or nine-digit (33558-3321) format is acceptable for the USA. Six digits (A0A 0A0) or (A0A0A0) format is acceptable for Canada.
     *
     * @return self
     */
     ...
     *
     * @param string $country_subdivision country_subdivision
     *
     * @return self
     */
