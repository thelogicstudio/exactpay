...
class BadRequestX2ErrorV410PathIssues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'field_path' => '\TheLogicStudio\ExactPay\Model\BadRequestX2ErrorV410PathIssuesFieldPathInner[]'
    ];
    ...
    */
     ...
     * Gets field_path
     *
     * @return \TheLogicStudio\ExactPay\Model\BadRequestX2ErrorV410PathIssuesFieldPathInner[]|null
     */
     ...
     * Sets field_path
     *
     * @param \TheLogicStudio\ExactPay\Model\BadRequestX2ErrorV410PathIssuesFieldPathInner[]|null $field_path It is a dynamic field representing the path where error exists. The value is an array of issues; each object is a problem that occurred during validation. The object name `fieldPath` is replaced by the actual field name with its path in the request object.
     *
     * @return self
     */
