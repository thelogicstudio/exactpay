...
/**
 * OrderResponseAccessToken Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class OrderResponseAccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderResponse_accessToken';
    ...
    */
     ...
     * Sets token
     *
     * @param string|null $token Create a new access token for this Order.
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param string|null $expires_at The date and time when the created token expires.
     *
     * @return self
     */
