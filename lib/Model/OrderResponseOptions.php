...
/**
 * OrderResponseOptions Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class OrderResponseOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderResponse_options';
    ...
    */
    ...
    public function setEcommerceFlag($ecommerce_flag)
    {
        ...
        if ((mb_strlen($ecommerce_flag) > 1)) {
            throw new \InvalidArgumentException('invalid length for $ecommerce_flag when calling OrderResponseOptions., must be smaller than or equal to 1.');
        }
     ...
     * Sets customer_ip
     *
     * @param string|null $customer_ip IP address of the customer.
     *
     * @return self
     */
