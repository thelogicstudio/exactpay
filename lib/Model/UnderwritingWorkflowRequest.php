...
class UnderwritingWorkflowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets rules
     *
     * @return \TheLogicStudio\ExactPay\Model\UnderwritingRuleRequestInner[]|null
     */
     ...
     * Sets rules
     *
     * @param \TheLogicStudio\ExactPay\Model\UnderwritingRuleRequestInner[]|null $rules The list of Rules available for the Underwriting Workflow process that can be used to evaluate the Onboarding Application.
     *
     * @return self
     */
