...
/**
 * OrderAccessTokenDetail Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class OrderAccessTokenDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderAccessTokenDetail';
    ...
    */
     ...
     * Sets token
     *
     * @param string|null $token The token which grants temporary API access to ExactJS.
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at When this access token expires, in ISO8601 format.
     *
     * @return self
     */
