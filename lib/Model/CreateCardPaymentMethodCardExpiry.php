...
/**
 * CreateCardPaymentMethodCardExpiry Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class CreateCardPaymentMethodCardExpiry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCardPaymentMethod_card_expiry';
    ...
    */
     ...
     * Sets month
     *
     * @param int $month Card expiry month.
     *
     * @return self
     */
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling CreateCardPaymentMethodCardExpiry., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling CreateCardPaymentMethodCardExpiry., must be bigger than or equal to 1.');
        }
     ...
     * Sets year
     *
     * @param int $year Card expiry year.
     *
     * @return self
     */
