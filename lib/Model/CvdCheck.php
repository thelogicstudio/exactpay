 ...
 */
class CvdCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CvdCheck';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code CVD response code received from the processor.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the CVD code.
     *
     * @return self
     */
