 ...
 */
class BusinessClassification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessClassification';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Dwolla's Business classification Identifier mapped to Organization or Account's MCC code.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Business classification name mapped to Organization or Account's MCC code.
     *
     * @return self
     */
