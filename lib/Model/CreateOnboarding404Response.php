...
/**
 * CreateOnboarding404Response Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class CreateOnboarding404Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createOnboarding_404_response';
    ...
    public const MESSAGE_ONBOARDING_WORKFLOW_NOT_FOUND = 'Onboarding Workflow Not Found';
    public const MESSAGE_SYSTEM_TOKEN_NOT_FOUND = 'System Token Not Found';
    public const MESSAGE_ORGANIZATION_NOT_FOUND = 'Organization Not Found';
    ...
    {
        return [
            self::MESSAGE_ONBOARDING_WORKFLOW_NOT_FOUND,
            self::MESSAGE_SYSTEM_TOKEN_NOT_FOUND,
            self::MESSAGE_ORGANIZATION_NOT_FOUND,
        ];
    }
