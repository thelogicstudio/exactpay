...
class PostCreateWorkflowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'entry_rule' => 'string',
        'rules' => '\TheLogicStudio\ExactPay\Model\UnderwritingRuleRequestInner[]',
        'metadata' => 'object'
    ];
    ...
    */
     ...
     * Gets rules
     *
     * @return \TheLogicStudio\ExactPay\Model\UnderwritingRuleRequestInner[]
     */
     ...
     * Sets rules
     *
     * @param \TheLogicStudio\ExactPay\Model\UnderwritingRuleRequestInner[] $rules The list of Rules available for the Underwriting Workflow process that can be used to evaluate the Onboarding Application.
     *
     * @return self
     */
