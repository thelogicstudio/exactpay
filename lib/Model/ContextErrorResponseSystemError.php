...
/**
 * ContextErrorResponseSystemError Class Doc Comment
 *
 * @category Class
 * @description This error object will be returned only in some situations when an Internal Server Error is returned.
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ContextErrorResponseSystemError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contextErrorResponseSystemError';
