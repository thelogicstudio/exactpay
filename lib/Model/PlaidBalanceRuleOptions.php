...
/**
 * PlaidBalanceRuleOptions Class Doc Comment
 *
 * @category Class
 ...
 */
class PlaidBalanceRuleOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlaidBalanceRule_options';
    ...
    */
     ...
     *
     * @param float $minimum_balance The minimum balance that the Account must have in order to pass the Rule. If the Account has a balance that is less than the minimum balance, the Rule will fail.
     *
     * @return self
     */
