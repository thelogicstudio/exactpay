...
/**
 * ContextErrorResponseUploadDocument Class Doc Comment
 *
 * @category Class
 * @description This error object will be returned only when the Organization doesn&#39;t exist scenario.
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ContextErrorResponseUploadDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contextErrorResponseUploadDocument';
