...
/**
 * InviteAccept Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class InviteAccept implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InviteAccept';
    ...
    */
     ...
     * Sets password
     *
     * @param string $password The password that the user decided to use to stablish its credentials in the system.
     *
     * @return self
     */
     ...
     * Sets application
     *
     * @param string|null $application The user credentials will be associated to this application.
     *
     * @return self
     */
