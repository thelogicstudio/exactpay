...
/**
 * PayWithDebitBillPayDebitBillPay Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class PayWithDebitBillPayDebitBillPay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayWithDebitBillPay_debitBillPay';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cvd_indicator', $data ?? [], '0');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['cardholder']) < 1)) {
    ...
    public function setCardholder($cardholder)
    {
        ...
        if ((mb_strlen($cardholder) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cardholder when calling PayWithDebitBillPayDebitBillPay., must be bigger than or equal to 1.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling PayWithDebitBillPayDebitBillPay., must be bigger than or equal to 1.');
        }
    ...
    public function setExpiryMonth($expiry_month)
    {
        ...
        if ((mb_strlen($expiry_month) < 1)) {
            throw new \InvalidArgumentException('invalid length for $expiry_month when calling PayWithDebitBillPayDebitBillPay., must be bigger than or equal to 1.');
        }
    ...
    public function setExpiryYear($expiry_year)
    {
        ...
        if ((mb_strlen($expiry_year) < 1)) {
            throw new \InvalidArgumentException('invalid length for $expiry_year when calling PayWithDebitBillPayDebitBillPay., must be bigger than or equal to 1.');
        }
     ...
     * Sets cvd
     *
     * @param string|null $cvd CVV or CVD of the card.
     *
     * @return self
     */
     ...
     * Sets cvd_indicator
     *
     * @param string|null $cvd_indicator `0` or `null` = Not Supported (Default), `1` = Value provided by Cardholder, `2` = Value provided on card is Illegible, `9` = Cardholder states data is not available.
     *
     * @return self
     */
