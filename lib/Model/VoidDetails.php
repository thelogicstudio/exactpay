 ...
 */
class VoidDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoidDetails';
    ...
    {
        $this->setIfExists('voids', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets voids
     *
     * @param string[]|null $voids The Payment identifiers of any void transactions.
     *
     * @return self
     */
    ...
    {
        if (is_null($voids)) {
            throw new \InvalidArgumentException('non-nullable voids cannot be null');
        }
