...
/**
 * PostPaymentMethod500Response Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class PostPaymentMethod500Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_payment_method_500_response';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Code of the system error.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Message explaining the system error.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type It is shown as system error.
     *
     * @return self
     */
