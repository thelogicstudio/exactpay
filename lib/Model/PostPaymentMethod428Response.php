...
/**
 * PostPaymentMethod428Response Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class PostPaymentMethod428Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_payment_method_428_response';
    ...
    public const MESSAGE_THE_ENCODED_KEY_WAS_NOT_RECOGNIZED = 'The encoded key was not recognized';
    public const MESSAGE_FAILED_TO_DECRYPT_PRIVATE_KEY = 'Failed to decrypt private key';
    ...
    {
        return [
            self::MESSAGE_THE_ENCODED_KEY_WAS_NOT_RECOGNIZED,
            self::MESSAGE_FAILED_TO_DECRYPT_PRIVATE_KEY,
        ];
    }
