...
/**
 * ReportQueryResponseParameters Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class ReportQueryResponseParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportQueryResponse_parameters';
    ...
    */
     ...
     * Sets start
     *
     * @param string|null $start Starting timestamp of data to be included in the Report.
     *
     * @return self
     */
