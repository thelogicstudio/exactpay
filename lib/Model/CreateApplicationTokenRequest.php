...
class CreateApplicationTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets permissions
     *
     * @return \TheLogicStudio\ExactPay\Model\Permissions[]
     */
     ...
     * Sets permissions
     *
     * @param \TheLogicStudio\ExactPay\Model\Permissions[] $permissions Operations that can be performed with the created Application Token. Giving the Application Token more permissions than those assigned to the current user who is creating the Application Token is not allowed.
     *
     * @return self
     */
