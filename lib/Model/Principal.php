...
class Principal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((!preg_match("/^(?!').*[a-zA-Z].*[\\w\\s']$/", ObjectSerializer::toString($first_name)))) {
    ...
    public function setLastName($last_name)
    {
        ...
        if ((!preg_match("/^(?!').*[a-zA-Z].*[\\w\\s']$/", ObjectSerializer::toString($last_name)))) {
    ...
    public function setTelephone($telephone)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", ObjectSerializer::toString($telephone)))) {
    ...
    public function setDriversLicense($drivers_license)
    {
        ...
        if ((!preg_match("/^[a-z0-9]+$/", ObjectSerializer::toString($drivers_license)))) {
