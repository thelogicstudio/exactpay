...
/**
 * AccountReportDetailsKycResultsInner Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExactPay
 * @author   OpenAPI Generator team
 ...
 */
class AccountReportDetailsKycResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountReportDetails_kycResults_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('original_response', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['original_response'];
    }

    /**
     * Sets original_response
     *
     * @param string|null $original_response original_response
     *
     * @return self
     */
    public function setOriginalResponse($original_response)
    {
        if (is_null($original_response)) {
            throw new \InvalidArgumentException('non-nullable original_response cannot be null');
        }
        $this->container['original_response'] = $original_response;
