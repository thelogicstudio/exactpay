 ...
 */
class ReportParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportParameters';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('end', $data ?? [], 'Current timestamp');
        $this->setIfExists('user', $data ?? [], '61a78fe82c3156b0945ef135');
    ...
    */
     ...
     * Sets start
     *
     * @param string $start Starting timestamp of data to be included in the Report.
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param string|null $end Ending timestamp of data to be included in the Report (inclusive until Report request).
     *
     * @return self
     */
     ...
     * Sets user
     *
     * @param string|null $user The target User to whom the Report is created. Leave it empty to use the current logged in User as default.
     *
     * @return self
     */
     ...
     * Sets accounts
     *
     * @param string[]|null $accounts The Organization or Account identifier to be included in the Report.
     *
     * @return self
     */
