...
**type** | **string** | Type of Rule that will be evaluated by the decision engine. | [optional] [default to 'Plaid Balance']
**options** | [**\TheLogicStudio\ExactPay\Model\PlaidBalanceRuleOptions**](PlaidBalanceRuleOptions.md) |  | [optional]
