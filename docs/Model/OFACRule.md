...
**type** | **string** | Type of Rule that will be evaluated by the decision engine. | [optional] [default to 'OFAC']
**options** | [**\TheLogicStudio\ExactPay\Model\OFACRuleOptions**](OFACRuleOptions.md) |  | [optional]
