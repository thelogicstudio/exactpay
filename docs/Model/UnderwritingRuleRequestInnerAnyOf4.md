...
**type** | **string** | Type of Rule that will be evaluated by the decision engine. | [default to 'Mastercard Match']
**options** | [**\TheLogicStudio\ExactPay\Model\MastercardRuleOptions**](MastercardRuleOptions.md) |  |
