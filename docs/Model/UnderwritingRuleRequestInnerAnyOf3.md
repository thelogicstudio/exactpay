...
**type** | **string** | Type of Rule that will be evaluated by the decision engine. | [default to 'OFAC']
**options** | [**\TheLogicStudio\ExactPay\Model\OFACRuleOptions**](OFACRuleOptions.md) |  |
